...
const APP_PLANS: StudioContent["plans"] = [
  {
    ...
    price: 29999,
    meta: "One-time • Ready in 2-4 weeks",
    features: [
      "Core product flow architecture",
      "Auth, onboarding, and profile setup",
      "Admin-ready backend baseline",
      "Stable API and error-state handling",
  ...
  },
  {
    ...
    price: 89999,
    priceSuffix: "+",
    meta: "One-time • Ready in 6-10 weeks",
    features: [
      "Custom architecture for scale",
      "Payments, subscriptions, and billing",
      "Security hardening and monitoring",
      "App store production readiness",
      "Priority launch and growth support",
    ],
    cta: "Get Started",
    highlighted: false,
    icon: "shield",
