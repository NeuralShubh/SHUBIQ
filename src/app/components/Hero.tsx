...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      ref={sectionRef}
      className="relative isolate min-h-screen max-[768px]:min-h-[80svh] flex items-center justify-center overflow-visible px-5 max-[768px]:px-[14px] sm:px-6 pt-[14vh] max-[768px]:pt-[8.5vh] pb-10 max-[768px]:pb-2 sm:pb-16"
    >
      {/* Background grid */}
      <div
      ...
      <div className="hero-content relative z-20 text-center w-full mx-auto md:-translate-y-10 max-[768px]:-translate-y-4 overflow-visible">
