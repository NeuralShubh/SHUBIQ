...
const plans = [
  {
    name: 'Launch',
    price: '35,000',
    period: 'starting package • typical 2-3 weeks',
    bestFor: 'Best for focused launch goals',
    features: [
  ...
  },
  {
    name: 'Growth',
    price: '75,000',
    period: 'starting package • typical 3-5 weeks',
    bestFor: 'Best for growth-stage teams',
    features: [
  ...
  },
  {
    name: 'Scale',
    price: '1,50,000',
    period: 'starting package • timeline by scope',
    bestFor: 'Best for complex platform builds',
    features: [
      'Fully custom design',
      'Advanced SEO setup',
    ...
    <section id="pricing" className="relative py-24 px-6 bg-slate-50 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight mb-4">Studio Engagement Models</h2>
          <p className="text-slate-600 text-lg max-w-2xl mx-auto leading-relaxed">
            Structured pricing tracks designed for launch, growth, and scale requirements.
          </p>
          <div className="mt-6 inline-flex flex-wrap items-center justify-center gap-2 text-xs font-semibold">
            <span className="px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-100">Structured scope</span>
            <span className="px-3 py-1.5 rounded-full bg-blue-50 text-blue-700 border border-blue-100">Transparent pricing</span>
            <span className="px-3 py-1.5 rounded-full bg-violet-50 text-violet-700 border border-violet-100">Scalable delivery</span>
          </div>
        </motion.div>
          ...
          {plans.map((plan, i) => (
            ...
            >
              ...
              <p className={`text-xs font-semibold mb-3 ${plan.popular ? 'text-blue-100' : 'text-slate-500'}`}>{plan.bestFor}</p>
                ...
                <span className={`text-lg font-bold mt-2 ${plan.popular ? 'text-blue-100' : 'text-slate-800'}`}>Starting from ₹</span>
        ...
        <p className="text-center text-sm text-slate-500 mt-8">
          Need a custom scope? <a href="#contact" className="font-semibold text-blue-700 hover:text-blue-600">Request a studio quote</a>.
        </p>
      </div>
    </section>
  )
