...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-slate-50 px-6 pt-28 pb-20">
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }}>
            <h1 className="font-black text-5xl lg:text-7xl leading-[1.05] tracking-tight text-slate-900 mb-7">
            ...
            <p className="text-xl text-slate-600 leading-relaxed max-w-xl mb-10">
              Modern, scalable websites and digital platforms engineered for growth-focused businesses.
            </p>
