...
const trustPoints = ['Structured discovery', 'Transparent scope', 'Studio-grade execution']
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-9 xl:gap-12 items-start">
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed mb-6 text-[1.18rem] max-w-lg">
              Share your business goals and digital scope. The studio will respond with a clear roadmap and execution path.
            </p>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="mb-5">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    placeholder="Share your product scope, goals, and preferred timeline..."
