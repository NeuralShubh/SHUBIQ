...
const FOOTER_LINKS = {
  Services: [
    { label: 'Business Platforms', href: '#services' },
    { label: 'Conversion Systems', href: '#services' },
    { label: 'Commerce Infrastructure', href: '#services' },
    { label: 'Experience Revamp', href: '#services' },
    { label: 'Growth Maintenance', href: '#services' },
  ],
  Company: [
